    ...
    public class StageBaselineExtractRepository : IStageBaselineExtractRepository
    {
        ...
        public async Task SyncStage(List<StageBaselineExtract> extracts, Guid manifestId)
        {
            try
            {
                ...
                var notification = new ExtractsReceivedEvent { TotalExtractsStaged = extracts.Count, ManifestId = manifestId, SiteCode = extracts.First().SiteCode, ExtractName = "PatientBaselineExtract" };
        ...
        private async Task InsertNewDataFromStaging(List<StageBaselineExtract> uniqueStageExtracts)
        {
            try
            {
        ...
        private async Task UpdateCentralDataWithStagingData(List<StageBaselineExtract> stageBaseline, IEnumerable<PatientBaselinesExtract> existingRecords)
        {
            try
            {
