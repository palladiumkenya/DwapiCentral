...
namespace DwapiCentral.Ct.Infrastructure.Persistence.Repository.Stage
{
    public class StageDepressionScreeningExtractRepository :IStageDepressionScreeningExtractRepository
    {
        ...
        private async Task MergeExtracts(Guid manifestId, List<StageDepressionScreeningExtract> stageDepression)
        {
            ...
            try
            {
                ...
                if (existingRecordsSet.Any())
                {
                    ...
                    await UpdateCentralDataWithStagingData(stageDepression, existingRecords);
                }
                else
                {
                    uniqueStageExtracts = stageDepression;
        ...
        private async Task InsertNewDataFromStaging(List<StageDepressionScreeningExtract> uniqueStageExtracts)
        {
            try
            {
        ...
        private async Task UpdateCentralDataWithStagingData(List<StageDepressionScreeningExtract> stageDepression, IEnumerable<DepressionScreeningExtract> existingRecords)
        {
            try
            {
