    ...
    public class StageIptExtractRepository :IStageIptExtractRepository
    {
        ...
        public async Task SyncStage(List<StageIptExtract> extracts, Guid manifestId)
        {
            try
            {
                ...
                var notification = new ExtractsReceivedEvent { TotalExtractsProcessed = extracts.Count, ManifestId = manifestId, SiteCode = extracts.First().SiteCode, ExtractName = "IptExtract" };
