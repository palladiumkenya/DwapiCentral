...
namespace DwapiCentral.Ct.Infrastructure.Persistence.Repository.Stage
{
...

    {
        ...
        //                    new { manifestId, facilityId }, transaction, 0);
        //                transaction.Commit();
        //            }
        //        }
        //    }
        ...
        //                {
        //                    // clear visit
        //                    var sqlDelete = $@"DELETE FROM {_extractName} 
        //                    WHERE PatientId IN (SELECT {nameof(PatientExtract.Id)} FROM {nameof(PatientExtract)} WHERE 
        //                    {nameof(PatientExtract.FacilityId)}=@facilityId)  ";
        ...
        //                            Action = action,
        //                            Area = area,
        //                            FacilityId = site.FacilityId.Value,
