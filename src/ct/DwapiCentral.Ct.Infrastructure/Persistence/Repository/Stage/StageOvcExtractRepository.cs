...
namespace DwapiCentral.Ct.Infrastructure.Persistence.Repository.Stage
{
    public class StageOvcExtractRepository : IStageOvcExtractRepository
    {
        ...
        private async Task MergeExtracts(Guid manifestId, List<StageOvcExtract> stageOvc)
        {
            ...
            try
            {
                ...
                if (existingRecordsSet.Any())
                {
                    ...
                    await UpdateCentralDataWithStagingData(stageOvc, existingRecords);
                }
                else
                {
                    uniqueStageExtracts = stageOvc;
        ...
        private async Task InsertNewDataFromStaging(List<StageOvcExtract> uniqueStageExtracts)
        {
            try
            {
        ...
        private async Task UpdateCentralDataWithStagingData(List<StageOvcExtract> stageOvc, IEnumerable<OvcExtract> existingRecords)
        {
            try
            {
