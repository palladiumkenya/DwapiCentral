...
public class TestHelper
{
    ...
    public static List<PatientVisitExtract> GetTestPatientVisitExtractsUpdates()
    {
        return new List<PatientVisitExtract>()
        {
            new PatientVisitExtract() {Id=new Guid("017EC6FE-A65F-4F3E-AEA5-C680C13AC8E8"), PatientPk = 1, SiteCode = -10000,VisitDate=DateTime.Now,Weight=67},
            new PatientVisitExtract() {Id=new Guid("017EC6FE-A65F-4F3E-AEA6-C680C13AC8E8"), PatientPk = 1, SiteCode = -10000,VisitDate=DateTime.Now,Height=162},
            new PatientVisitExtract() {Id=new Guid("017EC6FE-A65F-4F3E-AEA7-C680C13AC8E8"), PatientPk = 2, SiteCode = -10000,VisitDate=DateTime.Today.AddDays(-2),Height = 163,Weight=56},
            new PatientVisitExtract() {Id=new Guid("017EC6FE-A65F-4F3E-AEA8-C680C13AC8E8"), PatientPk = 2, SiteCode = -10000,VisitDate = DateTime.Today.AddDays(-1),Height=163,Weight=58}
