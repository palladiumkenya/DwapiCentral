    ...
    public class StageHtsClientLinkageRepository : IStageHtsClientLinkageRepository
    {
        ...
        public async Task SyncStage(List<StageHtsClientLinkage> extracts, Guid manifestId)
        {
            try
            {
                ...
                var notification = new ExtractsReceivedEvent { TotalExtractsProcessed = extracts.Count, ManifestId = manifestId, SiteCode = extracts.First().SiteCode, ExtractName = "HtsClientLinkageExtract" };
