    ...
    public class StagePrepPharmacyRepository : IStagePrepPharmacyRepository
    {
        ...
        public async Task SyncStage(List<StagePrepPharmacy> extracts, Guid manifestId)
        {
            try
            {
                ...
                var notification = new ExtractsReceivedEvent { TotalExtractsStaged = extracts.Count, ManifestId = manifestId, SiteCode = extracts.First().SiteCode, ExtractName = "PrepPharmacys" };
