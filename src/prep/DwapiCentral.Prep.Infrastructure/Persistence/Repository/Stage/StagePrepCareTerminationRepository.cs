    ...
    public class StagePrepCareTerminationRepository : IStagePrepCareTerminationRepository
    {
        ...
        public async Task SyncStage(List<StagePrepCareTermination> extracts, Guid manifestId)
        {
            try
            {
                ...
                var notification = new ExtractsReceivedEvent { TotalExtractsProcessed = extracts.Count, ManifestId = manifestId, SiteCode = extracts.First().SiteCode, ExtractName = "PrepCareTerminations" };
