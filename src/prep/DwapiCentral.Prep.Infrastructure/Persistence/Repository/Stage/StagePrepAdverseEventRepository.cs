    ...
    public class StagePrepAdverseEventRepository : IStagePrepAdverseEventRepository
    {
        ...
        public async Task SyncStage(List<StagePrepAdverseEvent> extracts, Guid manifestId)
        {
            try
            {
                ...
                var notification = new ExtractsReceivedEvent { TotalExtractsStaged = extracts.Count, ManifestId = manifestId, SiteCode = extracts.First().SiteCode, ExtractName = "PrepAdverseEvents" };
