    ...
    public class StageCwcVisitRepository : IStageCwcVisitRepository
    {
        ...
        public async Task SyncStage(List<StageCwcVisit> extracts, Guid manifestId)
        {
            try
            {
                ...
                var notification = new ExtractsReceivedEvent { TotalExtractsProcessed = extracts.Count, ManifestId = manifestId, SiteCode = extracts.First().SiteCode, ExtractName = "CwcVisits" };
