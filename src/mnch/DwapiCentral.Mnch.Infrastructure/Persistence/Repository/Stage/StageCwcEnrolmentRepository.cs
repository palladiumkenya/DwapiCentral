    ...
    public class StageCwcEnrolmentRepository : IStageCwcEnrolmentRepository
    {
        ...
        public async Task SyncStage(List<StageCwcEnrolment> extracts, Guid manifestId)
        {
            try
            {
                ...
                var notification = new ExtractsReceivedEvent { TotalExtractsStaged = extracts.Count, ManifestId = manifestId, SiteCode = extracts.First().SiteCode, ExtractName = "CwcEnrolments" };
