    ...
    public class StageMnchArtRepository : IStageMnchArtRepository
    {
        ...
        public async Task SyncStage(List<StageMnchArt> extracts, Guid manifestId)
        {
            try
            {
                ...
                var notification = new ExtractsReceivedEvent { TotalExtractsProcessed = extracts.Count, ManifestId = manifestId, SiteCode = extracts.First().SiteCode, ExtractName = "MnchArts" };
