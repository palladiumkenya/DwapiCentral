    ...
    public class StageHeiExtractRepository : IStageHeiExtractRepository
    {
        ...
        public async Task SyncStage(List<StageHeiExtract> extracts, Guid manifestId)
        {
            try
            {
                ...
                var notification = new ExtractsReceivedEvent { TotalExtractsProcessed = extracts.Count, ManifestId = manifestId, SiteCode = extracts.First().SiteCode, ExtractName = "HeiExtract" };
