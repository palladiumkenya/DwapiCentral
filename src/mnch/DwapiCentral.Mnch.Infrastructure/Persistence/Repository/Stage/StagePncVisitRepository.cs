    ...
    public class StagePncVisitRepository : IStagePncVisitRepository
    {
        ...
        public async Task SyncStage(List<StagePncVisit> extracts, Guid manifestId)
        {
            try
            {
                ...
                var notification = new ExtractsReceivedEvent { TotalExtractsProcessed = extracts.Count, ManifestId = manifestId, SiteCode = extracts.First().SiteCode, ExtractName = "PncVisits" };
